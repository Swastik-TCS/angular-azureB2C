...
export const b2cPolicies = {
    ...
    authorityDomain: 'identifenceb2cdev.b2clogin.com',
};
...
export const msalConfig: Configuration = {
    auth: {
        //clientId: '3e86a0f6-3d4f-4820-9566-6a046596b5c0', // This is the ONLY mandatory field that you need to supply.
        clientId: '257d3114-3f64-49b2-8541-cbc02438c668',
...
export const msalInterceptorConfig: MsalInterceptorConfiguration = {
    ...
    protectedResourceMap: new Map([
        ["<Enter Backend API endpoint>", ["Scope exposed by the api endpoint"]],
      ])
}
/**
